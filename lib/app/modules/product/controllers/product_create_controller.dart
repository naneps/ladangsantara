...
import 'package:ladangsantara/app/models/category_model.dart';
...
class ProductCreateController extends GetxController with StateMixin {
  ...
  Future<void> createProduct() async {
    ...
    await productProvider
      ...
      if (res.body['status'] == 'SUCCESS') {
        ...
        Utils.snackMessage(
            title: "Berhasil",
            messages: "Berhasil Menambahkan ${product.value.name}}",
            type: "success");
