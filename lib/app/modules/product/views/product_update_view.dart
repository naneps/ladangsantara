...
class ProductUpdateView extends GetView<ProductUpdateController> {
        ...
        child: RoundedContainer(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                XPickerImage(
                  networkImage: controller.product.value.image,
                  onImagePicked: (val) {
                ...
                XTextField(
                  ...
                  initialValue: controller.product.value.stock.toString(),
